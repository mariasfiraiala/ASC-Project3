...
# The results are from the optimized solution (solve_opt_m.c)
# File name is opt.p
set title "Matrix multiplication - optimized"
set xlabel "Size (elements of type double)"
set ylabel "Time (seconds)"
set xrange[0:1600]
set yrange[0:50]
plot "../samples/opt.txt" using 1:2 title "Average time" with linespoints,\
